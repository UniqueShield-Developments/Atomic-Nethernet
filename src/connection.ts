...
const ensureBuffer = (data: Buffer | string | ArrayBuffer | ArrayBufferView): Buffer => {
...
export class Connection {
  public nethernet: ClientLike;
  public address: bigint;
  public rtcConnection: any;
  public reliable: any;
  public unreliable: any;
  public promisedSegments: number;
  ...
  setChannels(reliable?: any | null, unreliable?: any | null) {
    if (reliable) {
      this.reliable = reliable;
      this.reliable.binaryType = 'arraybuffer';
      this.reliable.onmessage = (event: any) => {
        this.handleMessage(event.data as any);
      };
  ...
  handleMessage(data: Buffer | string | ArrayBuffer | ArrayBufferView) {
    const payload = ensureBuffer(data as any);
  ...
  send(data: Buffer | string | ArrayBuffer | ArrayBufferView) {
